...
if (isset($_SESSION['email'])){
    ...
    echo "<script> location = 'halamanutamaadmin.php';</script>";
}
...
<head>
    ...
    <link rel="stylesheet" href="logineditadmin.css">
    <title>YUK WARNET</title>

</head>
<body>
    <form action="koneksitubes.php?proses_loginadmin" method="POST">
    <div class="gambar">
